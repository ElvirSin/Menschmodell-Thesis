...
public class PanelMovementR2ButtonHandler : MonoBehaviour
{
    // Local variables
    // The panels
    ...
    public void PickUp()
    {
        //GameObject.Find("Scripts").GetComponent<SpawnHandler>().RemoveR2();
        GameObject.Find("Scripts").GetComponent<SpawningHandler>().RemoveRobot(2);
    }
}
