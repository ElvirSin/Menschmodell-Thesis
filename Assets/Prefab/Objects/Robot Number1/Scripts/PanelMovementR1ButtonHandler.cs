...
public class PanelMovementR1ButtonHandler : MonoBehaviour
{
    // Local variables
    // The panels
    ...
    public void PickUp()
    {
        //GameObject.Find("Scripts").GetComponent<SpawnHandler>().RemoveR1();
        GameObject.Find("Scripts").GetComponent<SpawningHandler>().RemoveRobot(1);
    }
}