...
public class PanelMovementR3ButtonHandler : MonoBehaviour
{
    // Local variables
    // The panels
    ...
    public void PickUp()
    {
        //GameObject.Find("Scripts").GetComponent<SpawnHandler>().RemoveR3();
        GameObject.Find("Scripts").GetComponent<SpawningHandler>().RemoveRobot(3);
    }
}
